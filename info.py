...
USERNAME = environ.get('USERNAME', "https://t.me/Mr_Official_300") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/CpFlicks_Movies')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002420336319'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002420336319'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002488685079'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002152223940') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001774032706')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/CpFlicks_Support') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "Https://competent-allyson-moviezworld-5fd99891.koyeb.app/")
